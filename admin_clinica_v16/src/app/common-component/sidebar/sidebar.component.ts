...
export class SidebarComponent {
  ...
  constructor(
    ...
    if(this.user.roles.includes('Super-Admin')){
      ...
      //Se filtran las vistas a las que tiene acceso de acuerdo con su rol
      ...
      this.data.sideBar.forEach((side:any) => {
        ...
        side.menu.forEach((menu_s:any) => {
          let SUB_MENUS = menu_s.subMenus.filter((submenu:any) => permissions.includes(submenu.permision) && submenu.show_nav === true);
